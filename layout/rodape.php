...
<footer class="site-footer">
    <div class="footer-inner">
        ...
        <div class="footer-col">
            <h4>Acesso Rápido</h4>
            <ul>
                <li><a href="<?= $basePath ?>paginas/cadastro.php">Cadastrar Atletas</a></li>
                <li><a href="<?= $basePath ?>paginas/grupos.php">Sortear Grupos</a></li>
                <li><a href="<?= $basePath ?>paginas/rodadas.php">Rodadas</a></li>
                <li><a href="<?= $basePath ?>paginas/classificacao.php">Classificação</a></li>
            </ul>
        </div>
        <div class="footer-col">
            <h4>Regulamento</h4>
